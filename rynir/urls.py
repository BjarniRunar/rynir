...
urlpatterns = patterns('',
    ...
    (r'^thingmenn/(?P<althingi_id>[^/]+)/upp=(?P<uppreisn>-?\d+)/?$',
                                                  'althingi.views.thingmadur'),
    (r'^thingmenn/(?P<althingi_id>[^/]+)/ja=(?P<ja>-?\d+)/?$',
                                                  'althingi.views.thingmadur'),
    (r'^thingmenn/(?P<althingi_id>[^/]+)/nei=(?P<nei>-?\d+)/?$',
                                                  'althingi.views.thingmadur'),
    (r'^thingmenn/(?P<althingi_id>[^/]+)/ekki=(?P<ekki>-?\d+)/?$',
                                                  'althingi.views.thingmadur'),
